...
- (void)uploadFileWithAppID:(id)arg1 appVersion:(unsigned long long)arg2 isIgnoreCheckDomain:(_Bool)arg3 taskID:(id)arg4 url:(id)arg5 localID:(id)arg6 fileFieldName:(id)arg7 httpHeaders:(id)arg8 formFields:(id)arg9 completionHandler:(CDUnknownBlockType)arg10;
- (id)genUploadTaskID;
