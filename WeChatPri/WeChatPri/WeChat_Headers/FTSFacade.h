...
@class AsyncTaskQueueEngine, FTSContactMgr, FTSDB, FTSFavMgr, FTSMemorySearchMgr, FTSMessageMgr, FTSReportMgr, FTSTopHitMgr, FTSWebSearchMgr, MCSBrandContactMgr, NSMutableSet, NSRecursiveLock, NSString, WALocalSearchMgr, WSMusicMgr, WebSearchRedotMgr;
