...
- (void)requestWithAppID:(id)arg1 appVersion:(unsigned long long)arg2 isIgnoreCheckDomain:(_Bool)arg3 taskID:(id)arg4 url:(id)arg5 data:(id)arg6 httpHeaders:(id)arg7 method:(id)arg8 completionHandler:(CDUnknownBlockType)arg9;
- (id)genRequestTaskID;
