...
- (id)getWCPayMessageBizExtArrayOnProperty:(const vector_24c76cbd *)arg1 where:(const struct WCDBConditionBase *)arg2;
- (_Bool)insertWCPayMessageBizExt:(id)arg1 onProperty:(const vector_24c76cbd *)arg2;
- (_Bool)isWCPayMessageBizExtExistWithChatname:(id)arg1 localId:(unsigned int)arg2;
- (unsigned int)GetCountOfNewWCPayBizExtOnDistinctProperty:(const struct WCDBConditionBase *)arg1 Where:(const struct WCDBConditionBase *)arg2 bizType:(unsigned int)arg3;
...
- (_Bool)deleteNewWCPayBizExtMsg:(const struct WCDBConditionBase *)arg1 OnType:(unsigned int)arg2;
...
- (id)getWCPayMessageBizExtArrayOnProperty:(const vector_24c76cbd *)arg1 where:(const struct WCDBConditionBase *)arg2 OnType:(unsigned int)arg3;
- (_Bool)insertWCPayMessageBizExt:(id)arg1 onProperty:(const vector_24c76cbd *)arg2 type:(unsigned int)arg3;
...
- (_Bool)InsertBackupMessageExt:(id)arg1 withChatName:(id)arg2 onProperty:(const vector_24c76cbd *)arg3;
...
- (id)GetMessagesByChatName:(id)arg1 onProperty:(const vector_24c76cbd *)arg2 where:(const struct WCDBConditionBase *)arg3 order:(const struct WCDBConditionBase *)arg4 limit:(unsigned int)arg5 hasError:(_Bool *)arg6;
...
- (unsigned int)GetMinCreateTimeInMessage:(id)arg1 where:(const struct WCDBConditionBase *)arg2;
