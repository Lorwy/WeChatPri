...
- (_Bool)StartSnsVideoDownload:(id)arg1 withIPList:(id)arg2 withRefer:(id)arg3 DownloadMode:(int)arg4 downloadPercent:(unsigned int)arg5;
- (_Bool)StartHttpVideoStreamingDownload:(id)arg1 withIPList:(id)arg2 withRefer:(id)arg3 withPlayMode:(_Bool)arg4;
- (_Bool)StartSnsVideoPreDownload:(id)arg1 withIPList:(id)arg2 withRefer:(id)arg3 downloadPercent:(unsigned int)arg4;
