...
@class ForwardMessageLogicController, NSArray, NSDictionary, NSMutableDictionary, NSMutableSet, NSString, NSURLRequest, UIColor, UILongPressGestureRecognizer, UIScreenEdgePanGestureRecognizer, UIView, WAAppActionSheet, WAAppTaskReferrerInfo, WABaseWebViewBanener, WAJumpBackInteractiveTransition, WANavLoadingLayer, WAWebViewJSLogicImpl, WAWebViewPluginScheduler;
