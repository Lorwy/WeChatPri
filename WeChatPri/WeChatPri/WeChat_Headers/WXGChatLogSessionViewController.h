...
@interface WXGChatLogSessionViewController : MMUIViewController <UITableViewDataSource, UITableViewDelegate, MMLoadSessionExt, UIAlertViewDelegate, WXGSelectTimeViewControllerDelegate>
{
