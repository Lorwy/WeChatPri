...
- (void)offlinePayAckMsg:(id)arg1 ReqKey:(id)arg2 PayMsgType:(int)arg3 TransId:(id)arg4 Processed:(_Bool)arg5;
- (void)offlineCancelPay:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (unsigned int)startGroupPayLogicFromOrder:(id)arg1 controlData:(id)arg2;
