...
@class EditImageAttr, EditImageIntialView, EditVideoLogicItem, MMCircularProgressView, MMLoadingView, MMSightRecordView, NSMutableArray, NSString, ShortVideoToolbarPreviewView, SightCameraTopToolView, UIButton, UIImage, UIImageView, UILabel, UIView;
@protocol ShortVideoBarDelegate, SightPreviewView;

@interface ShortVideoToolbar : MMUIView <UIAlertViewDelegate, MonoServiceLogicExt, EditVideoLogicItemDelegate, SightFiltersExt, UITextFieldDelegate, EditImageInitialViewDelegate>
{
    _Bool m_isActive;
    double m_topPositon;
