...
- (void)startUploadTaskWithURL:(id)arg1 taskID:(id)arg2 localID:(id)arg3 fileFieldName:(id)arg4 httpHeaders:(id)arg5 formFields:(id)arg6 isIgnoreCheckDomain:(_Bool)arg7 completionHandler:(CDUnknownBlockType)arg8;
- (void)dealloc;
