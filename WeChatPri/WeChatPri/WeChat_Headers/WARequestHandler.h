...
- (void)startRequestTaskWithURL:(id)arg1 taskID:(id)arg2 data:(id)arg3 httpHeaders:(id)arg4 method:(id)arg5 isIgnoreCheckDomain:(_Bool)arg6 completionHandler:(CDUnknownBlockType)arg7;
- (void)dealloc;
