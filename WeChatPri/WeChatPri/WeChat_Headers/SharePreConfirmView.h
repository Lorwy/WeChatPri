...
@class ChatroomProfileView, EmoticonBoardView, MMGrowTextView, NSArray, NSString, NamePreLabel, PreViewMsgContentLogic, UIButton, UIImage, UIImageView, UILabel, UIView, UIViewController, WCInputController;
@protocol SharePreConfirmViewDelegate;

@interface SharePreConfirmView : MMUIWindow <IUiUtilExt, MMKernelExt, BaseMsgContentDelgate, MMGrowTextViewDelegate, UIAlertViewDelegate, IMsgExt, InputControllerDelegate, IMMGrowTextViewExt>
{
    ...
    PreViewMsgContentLogic *m_preViewMultiMsgLogic;
...
- (void)showPreViewAnimate:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
