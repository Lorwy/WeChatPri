...
- (void)onMusicStopError:(MMMusicInfo *)arg1 errInfo:(MMMusicPlayerErrInfo *)arg2;
- (void)onMusicPlayFinish:(MMMusicInfo *)arg1;
- (void)onMusicSeekEnd:(MMMusicInfo *)arg1;
- (void)onMusicSeeking:(MMMusicInfo *)arg1;
- (void)onMusicInitAlready:(MMMusicInfo *)arg1;
