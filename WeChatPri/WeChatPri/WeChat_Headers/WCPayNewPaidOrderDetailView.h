...
@interface WCPayNewPaidOrderDetailView : MMUIView
{
    ...
    MMWebImageView *_tinyAppActivityLogoImgView;
...
@property(retain, nonatomic) MMWebImageView *tinyAppActivityLogoImgView; // @synthesize tinyAppActivityLogoImgView=_tinyAppActivityLogoImgView;
