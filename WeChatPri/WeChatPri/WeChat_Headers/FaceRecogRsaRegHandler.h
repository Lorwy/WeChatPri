...
@protocol FaceRecogRsaRegHandlerDelegate;

@interface FaceRecogRsaRegHandler : MMObject <IDCHostMgrExt, IRsaCertMgrExt, FaceRecogProcessorDelegate, FaceRecogConfigLogicDelegate, FaceRecogUploadLogicDelegate, FaceRecogVerifyViewControllerDelegate>
{
    _Bool _isRetry;
    int _idcRedirectCount;
    id <FaceRecogRsaRegHandlerDelegate> _delegate;
...
@property(nonatomic) __weak id <FaceRecogRsaRegHandlerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)doStartRegisterFaceProcedure;
- (void)doStartRegisterFace;
