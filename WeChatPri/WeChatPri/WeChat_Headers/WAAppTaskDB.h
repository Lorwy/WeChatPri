...
@property(retain) WCDataBaseTable *tableLocalStorageDataInfo; // @synthesize tableLocalStorageDataInfo=_tableLocalStorageDataInfo;
@property(retain) WCDataBaseTable *tableLocalStorageMainInfo; // @synthesize tableLocalStorageMainInfo=_tableLocalStorageMainInfo;
