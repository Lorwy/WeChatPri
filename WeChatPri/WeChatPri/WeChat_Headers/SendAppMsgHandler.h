...
@class AppCommunicateData, CContact, CMessageWrap, ForwardMessageLogicController, MMUINavigationController, NSString, UIAlertView, WAContactGetter, WXMediaInternalMessage;
