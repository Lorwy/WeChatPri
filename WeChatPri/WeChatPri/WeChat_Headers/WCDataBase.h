...
- (void)bindPropertys:(id)arg1 toSTMT:(struct sqlite3_stmt *)arg2 withSpecificProperty:(const set_e30b9d5d *)arg3 isAutoIncrement:(_Bool *)arg4;
- (void)generateInsertSQLString:(basic_string_a490aa4c *)arg1 withSpecificProperty:(const set_e30b9d5d *)arg2 isReplaceOnConflict:(_Bool)arg3 cls:(Class)arg4 tableName:(id)arg5;
- (set_e30b9d5d)dumpSpecificProperty:(const vector_24c76cbd *)arg1;
...
- (id)getMinProperty:(const struct WCDBConditionBase *)arg1 where:(const struct WCDBConditionBase *)arg2 ofClass:(Class)arg3 fromTable:(id)arg4;
- (id)getMinProperty:(const struct WCDBConditionBase *)arg1 ofClass:(Class)arg2 fromTable:(id)arg3;
