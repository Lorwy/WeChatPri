...
@interface MMMusicPlayerMgr : MMService <MMImageLoaderObserver, IRemoteControlMusicPlayerExt, PBMessageObserverDelegate, MMService, MMMusicPlayerExt, MMMusicLyricsRtnExt, MMMusicAlbumRtnExt, MMMusicListExt, ISysCallCheckExt>
{
...
@property(nonatomic) int m_lastState; // @synthesize m_lastState;
...
- (void)onMusicPlayErrorStop:(id)arg1;
