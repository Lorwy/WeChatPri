...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSThread, WAAppTaskExtInfo, WAJSContext, WAJSContextPluginScheduler, WAJSCoreServiceOpenData, WAWebViewController, WxaExternalInfo;
