...
@class CContact, MMTimer, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, WAAppOpenParameter, WAAppTaskExtInfo, WAAppTaskLoader, WAAppTaskReferrerInfo, WAAppTaskShowFromBackgroundContext, WAJSCoreService, WAPermissionHandler, WAWebViewController, WxaExternalInfo;
...
- (void)removeJumpInfoOnExitWithLastAppID:(id)arg1 andSetBackReferrerInfo:(id)arg2 forPreviousWeApp:(id)arg3;
...
- (_Bool)processWeAppPageAndRemoveJumpInfoOnExit;
...
- (_Bool)isTaskRunning;
- (void)stopHangUp;
- (void)enterBackgroundOnLaunchNativePage:(id)arg1 isWebPage:(_Bool)arg2;
- (void)enterForegroundIfBackFromNativePage;
- (void)enterBackgroundOnOpenNativePageOrJumpOtherWeApp;
...
- (void)webViewDidPresent:(id)arg1;
