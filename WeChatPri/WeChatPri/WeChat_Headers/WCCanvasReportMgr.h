...
- (void)reportCanvasAdInitWithSnsId:(id)arg1 uxInfo:(id)arg2 inScene:(int)arg3 withEnterType:(unsigned int)arg4 enableSwipe:(_Bool)arg5 componentItemsCount:(unsigned int)arg6 snsStatExt:(id)arg7 extraInfo:(id)arg8;
