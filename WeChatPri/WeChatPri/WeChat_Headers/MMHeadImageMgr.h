...
@interface MMHeadImageMgr : MMService <HeadImgDelegate, IContactMgrExt, IQQContactMgrExt, IBottleContactMgrExt, IStrangerContactMgrExt, IStrangerBrandContactHeadImageExt, WAContactMgrExtension, MessageObserverDelegate, IClearDataMgrExt, MMService>
{
